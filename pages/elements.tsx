  ...
  return (
    <section className="post">
      ...
      <p>
        ...
        is <u>underlined</u> and this is code:{' '}
        <code>
          for (;;) {'{'}...{'}'}
        </code>
      ...
      <div className="box alt">
        <div className="row 50% uniform">
          <div className="4u">
            <span className="image fit">
              <img src="light/images/pic02.jpg" alt="" />
            </span>
          </div>
          <div className="4u">
            <span className="image fit">
              <img src="light/images/pic03.jpg" alt="" />
            </span>
          </div>
          <div className="4u$">
            <span className="image fit">
              <img src="light/images/pic04.jpg" alt="" />
            </span>
          </div>
          {/* Break */}
          <div className="4u">
      ...
      <p>
        <span className="image left">
          <img src="light/images/pic08.jpg" alt="" />
        </span>
        ...
        sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
        vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing
        accumsan eu faucibus. Integer ac pellentesque praesent. Vestibulum ante
        ipsum primis in faucibus magna blandit adipiscing eu felis iaculis.
      </p>
      <p>
        <span className="image right">
          <img src="light/images/pic09.jpg" alt="" />
        </span>
        Lorem ipsum dolor sit accumsan interdum nisi, quis tincidunt felis
        sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
        vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing
      ...
      <div className="box">
        <p>
          ...
          faucibus lorem ipsum dolor sit amet nullam. Integer ac pellentesque
          ...
          pellentesque praesent. Vestibulum ante ipsum primis in faucibus magna
 ...
 */
const Elements = ({ doc, menu, lang, preview }) => {
  if (doc && doc.data) {
